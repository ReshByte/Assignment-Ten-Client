  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10">
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-gray-600 text-sm">Explore, Create, and Share Artworks</p>
      </div>
          ...
          >
            ...
            >
              <path d="M24 4.557c-.883.392-1.832.656-2.828.775 
                ...
                2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 
                14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"></path>
            </svg>
          </a>
          <a
          ...
          >
            ...
            >
              <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 
                ...
                8.816 3.6.245 11.626.246 15.23 0 3.897-.266 
      ...
      <aside className="mt-4 text-center text-gray-600">
        <p>Contact: <a href="mailto:info@artify.com" className="link link-hover">redwanreshat@gmail.com</a> | +880 1763 254017</p>
        <p>Copyright © {new Date().getFullYear()} - All rights reserved by Reshat</p>
      </aside>
    </footer>
  );
};
